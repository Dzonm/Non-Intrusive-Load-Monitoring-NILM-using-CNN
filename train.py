...
def get_arguments():
    ...
    parser.add_argument(
        ...
        type=str,
        default='cnn',
        choices=['cnn', 'transformer', 'fcn', 'resnet','lstm'],
        help='Network architecture to use'
    )
    parser.add_argument(
        '--datadir',
        type=str,
        default='C:/Users/ID/nilmtk_test/mynilm/COMBINE_UKDALE+REFIT/merge/normalize/',
        help='Directory of the training samples.'
    )
    parser.add_argument(
        '--save_dir',
        type=str,
        default='C:/Users/ID/nilmtk_test/mynilm/ml_combine/models',
    ...
    parser.set_defaults(plot_display=True)
...
if __name__ == '__main__':
    ...
    def instantiate_model():
        ...
        if args.model_arch == 'lstm':
            return define_models.lstm(window_length)
