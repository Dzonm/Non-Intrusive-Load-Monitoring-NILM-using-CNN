...
def get_arguments():
    ...
    parser.add_argument('--datadir',
        type=str,
        default='C:/Users/ID/nilmtk_test/mynilm/UK-DALE/Data-set_Ced',
        help='this is the directory to the test data')
    parser.add_argument('--trained_model_dir',
        type=str,
        default='C:/Users/ID/nilmtk_test/mynilm/ml_Ced/models',
        help='this is the directory to the trained models')
    parser.add_argument('--model_arch',
        type=str,
        default='cnn',
        help='model architecture to test: cnn, lstm')
    parser.add_argument(
        '--save_dir',
        type=str,
        default='C:/Users/ID/nilmtk_test/mynilm/ml_Ced/models',
...
if __name__ == '__main__':
    ...
    if args.plot:
        ...
        plot_name = f'Test results on {test_filename}'
