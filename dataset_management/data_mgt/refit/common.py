...
params_appliance = {
    'kettle': {
        ...
        'on_power_threshold': 10.0, # was 2000 but too high for kettle in my house
        # Appliance max power draw (W).
        # From Zhenrui Yue, et. al., "BERT4NILM: A Bidirectional Transformer Model
        # for Non-Intrusive Load Monitoring".
        'max_on_power': 3000.0,#3998.0,
    ...
    'dishwasher': {
        'window_length': 599,
        'on_power_threshold': 30.0,
        'max_on_power': 2600.0,
        'min_on_duration': 1400.0,
        'min_off_duration': 1600.0,
        'alt_app_mean': 700.0,
        'alt_app_std': 1000.0,
        'c0': 1.0
    },
    'washingmachine': {
        ...
        'on_power_threshold': 20.0,
        'max_on_power': 2700.0,
        'min_on_duration': 1600.0,
        'min_off_duration': 800.0,
        'alt_app_mean': 400.0,
        'alt_app_std': 700.0,
        'c0': 1e-02
    }
...
def post_process_activations(ground_truth_activations, predicted_activations):
    """
    Post-processing algorithm to eliminate irrelevant activations.
    ...
    for activation in predicted_activations:
        if len(activation) >= min_length:
            updated_predicted_activations.append(activation)
            updated_predicted_energy[current_index:current_index + len(activation)] = activation
